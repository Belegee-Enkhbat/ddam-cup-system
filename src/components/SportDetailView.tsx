...
export function SportDetailView({ selectedSport }: SportDetailViewProps) {
  return (
            ...
            <div className="space-y-6">
              <div className="p-6 rounded-lg border border-slate-800 bg-slate-900/40">
                ...
                <div className="space-y-3 text-sm text-slate-300">
                  {sport.key === 'basketball' || sport.key === 'volleyball' ? (
                    <>
                      <p>• Players are assigned to specific zones on the court</p>
                      <p>• Defensive assignments are area-based rather than player-based</p>
                      <p>• Rotation occurs every set/half</p>
                      <p>• Helps develop team cohesion and positional play</p>
                    </>
                  ) : sport.key === 'chess' ? (
                    <>
                    ...
                    <>
                      <p>• Winners bracket for undefeated players</p>
                      <p>• Losers bracket for one-loss players</p>
                      <p>• Final match determines overall champion</p>
                      <p>• Every player gets a second chance</p>
                    </>
                  )}
                </div>
              </div>
